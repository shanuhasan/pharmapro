                    ...
                    <form method="POST" action="{{ route('medicines.update', $medicine->id) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="hsn_code" id="hsn_code" value="{{ old('hsn_code', $medicine->hsn_code) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
